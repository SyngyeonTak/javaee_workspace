...
<div class="container">
    ...
    <input type="text" id="fname" name="author" value = "<%=notice.getAuthor()%>" placeholder="Your name..">

    <label for="lname">title</label>
    <input type="text" id="lname" name="title" value = "<%=notice.getTitle()%>" placeholder="Your title">
